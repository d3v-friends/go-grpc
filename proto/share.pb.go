...
var file_share_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0x1c, 0x0a, 0x04, 0x55, 0x55, 0x49, 0x44,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x2a, 0x1b, 0x0a, 0x06, 0x49, 0x64, 0x78, 0x44, 0x69, 0x72,
	0x12, 0x07, 0x0a, 0x03, 0x41, 0x53, 0x43, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x44, 0x45, 0x53,
	0x43, 0x10, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_share_proto_goTypes = []interface{}{
	...
	(*Period)(nil),   // 4: proto.Period
	(*Pager)(nil),    // 5: proto.Pager
	(*UUID)(nil),     // 6: proto.UUID
}
var file_share_proto_depIdxs = []int32{
	1, // 0: proto.Period.equal:type_name -> proto.Time
	1, // 1: proto.Period.notEqual:type_name -> proto.Time
	1, // 2: proto.Period.gt:type_name -> proto.Time
	1, // 3: proto.Period.gte:type_name -> proto.Time
	1, // 4: proto.Period.lt:type_name -> proto.Time
	1, // 5: proto.Period.lte:type_name -> proto.Time
